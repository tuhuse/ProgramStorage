...
public class StickOutItemTongue : MonoBehaviour
{
    ...
    private ItemTongueHitJudger _tongueHitJudger;
    ...
    void Start()
    {
        ...
        _tongueHitJudger = new ItemTongueHitJudger(this.transform, GetComponent<SpriteRenderer>().sprite, _tongueStateController);
    ...
    /// </summary>
    public void ReceiveInputToTongue(int itemID)
    {
