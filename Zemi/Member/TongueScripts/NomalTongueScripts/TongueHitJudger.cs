...
public class TongueHitJudger
{
    ...
    private TongueHitDetector _hitDetector = new TongueHitDetector();
    ...
    public TongueHitJudger(Transform tongueTransform, Sprite tongueSprite, TongueStateController tongueStaetController)
    {
